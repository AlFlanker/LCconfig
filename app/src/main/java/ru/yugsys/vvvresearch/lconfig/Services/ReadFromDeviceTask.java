...
public class ReadFromDeviceTask extends AsyncTask<DataDevice, Void, DeviceEntry> {
    private DataDevice currentDataDevice = new DataDevice();
    private byte[] addressStart = new byte[8];
    private byte[] numberOfBlockToRead;
    private AsyncTaskCallBacks.ReadCallBack readCallBack;


    public ReadFromDeviceTask(byte[] addressStart, byte[] numberOfBlockToRead) {
    ...
    public void subscribe(AsyncTaskCallBacks.ReadCallBack readCallBack) {
