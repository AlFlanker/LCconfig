...
public class RequestManager {
     ...
     *
     * @return the new {@code RequestManager}
     */
    public static RequestManager newInstance() {
        return new RequestManager();
    }

    public RequestManager Build(String hostAPI, REST_FUNCTION function) {
        this.func = function;
        this.hostAPI = (hostAPI + select.get(function));
        return this;
    }

    public RequestManager addQueryParamets(REST.REST_PRM prm, String value) {
    ...
    public RequestManager addQueryParamets(REST.REST_PRM prm, Date value) {
    ...
    public RequestManager addDeviceEntry(DeviceEntry deviceEntry) {
