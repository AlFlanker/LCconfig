...
public class WriteToDeviceTask extends AsyncTask<DeviceEntry,Void,Byte>{

    public DeviceEntry devTEST;
    private DataDevice dataDevice;
    private AsyncTaskCallBacks.WriteCallback writeCallback;


    public WriteToDeviceTask(DataDevice dataDevice) {
    ...
    private byte[] getBytes(DeviceEntry object) {
        ...
        byte[] raw;
        try {
            raw = DeviceEntry.DeviceToByteArray(object);
    ...
    public void subscribe(AsyncTaskCallBacks.WriteCallback writeCallback){
