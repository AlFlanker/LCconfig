...
/**
 * DAO for table "DeviceEntries".
 */
public class DevEntryDao extends AbstractDao<DevEntry, Long> {

    public static final String TABLENAME = "DeviceEntries";

    /**
     * Properties of entity DevEntry.<br/>
    ...
    public DevEntryDao(DaoConfig config) {
        super(config);
    }

    public DevEntryDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"DeviceEntries\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"DeviceEntries\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, DevEntry entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, DevEntry entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void attachEntity(DevEntry entity) {
    ...
    @Override
    public DevEntry readEntity(Cursor cursor, int offset) {
        DevEntry entity = new DevEntry( //
    ...
    @Override
    public void readEntity(Cursor cursor, DevEntry entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(DevEntry entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }

    @Override
    public Long getKey(DevEntry entity) {
        if (entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(DevEntry entity) {
