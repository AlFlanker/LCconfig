...
/**
 * DAO for table "LCTable".
*/
public class DeviceEntryDao extends AbstractDao<DeviceEntry, Long> {

    public static final String TABLENAME = "LCTable";
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"LCTable\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"LCTable\"";
        db.execSQL(sql);
    }
