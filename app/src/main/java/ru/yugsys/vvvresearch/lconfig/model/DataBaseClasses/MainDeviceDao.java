 ...
 */
public class MainDeviceDao extends AbstractDao<MainDevice, Long> {

    public static final String TABLENAME = "Devices";

    /**
     * Properties of entity MainDevice.<br/>
    ...
    public MainDeviceDao(DaoConfig config) {
        super(config);
    }

    public MainDeviceDao(DaoConfig config, DaoSession daoSession) {
    ...
    @Override
    protected final void bindValues(DatabaseStatement stmt, MainDevice entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, MainDevice entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void attachEntity(MainDevice entity) {
    ...
    @Override
    public MainDevice readEntity(Cursor cursor, int offset) {
        MainDevice entity = new MainDevice( //
    ...
    @Override
    public void readEntity(Cursor cursor, MainDevice entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(MainDevice entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }

    @Override
    public Long getKey(MainDevice entity) {
        if (entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(MainDevice entity) {
