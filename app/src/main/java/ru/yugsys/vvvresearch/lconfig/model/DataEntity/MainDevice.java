...
public class MainDevice {
     ...
     */
    @Generated(hash = 618026415)
    private transient MainDeviceDao myDao;


    @Generated(hash = 749596981)
    public MainDevice(Long id, @NotNull String type, boolean isOTTA, String eui,
     ...
     */
    @Generated(hash = 292856535)
    public void __setDaoSession(DaoSession daoSession) {
        this.daoSession = daoSession;
        myDao = daoSession != null ? daoSession.getMainDeviceDao() : null;
    }
